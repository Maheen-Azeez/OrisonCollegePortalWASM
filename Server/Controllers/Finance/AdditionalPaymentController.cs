...
namespace OrisonCollegePortal.Server.Controllers.Students
{
    ...
    [ApiController]
    public class AdditionalPaymentController : ControllerBase
    {
        private IWebHostEnvironment _environment;
        private IAdditionalPayment _repository;
        public AdditionalPaymentController(IWebHostEnvironment environment, IAdditionalPayment repository)
        {
        ...
        [HttpGet]
        [Route("Get")]
        public async Task<ActionResult<IEnumerable<AdditionalTrack>>> Getdata(int BranchID, string AcademicYear, string Key)
        {
        ...
        [HttpGet]
        [Route("Additional")]
        public async Task<ActionResult<AdditionalTrack>> GetAdditional(int ID, int BranchID, string Key)
        {
        ...
        [HttpPost]
        [Route("SaveMas")]
        public async Task<IActionResult> SaveMaster(AdditionalTrack value, string Key)
        {
            try
            {
                long ID = 0;
        ...
        [HttpPost]
        [Route("UpdateMas")]
        public async Task<IActionResult> UpdateMas(AdditionalTrack value, string Key)
        {
            try
            {
                long ID = 0;
